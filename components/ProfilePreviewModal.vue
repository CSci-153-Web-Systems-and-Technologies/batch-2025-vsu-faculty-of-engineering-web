<template>
  ...
  >
    ...
    <div class="w-full max-w-2xl">
      <!-- Card (fixed height, internal scroll) -->
      <div
        ref="modalRef"
        class="relative flex flex-col w-full h-[80vh] max-h-[80vh] bg-white rounded-2xl"
      >
        ...
        <!-- Header -->
        <div
          class="flex flex-col w-full pt-16 pb-4 text-center bg-red-900 rounded-t-2xl"
        >
        ...
        <div class="flex-1 overflow-y-auto px-6 pb-8 md:px-10">
          <!-- Info Section -->
          <div class="mt-6 space-y-6">
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 text">
              <div class="flex flex-col">
                <span class="text-sm font-bold text-red-900 font-montserrat">
                  Full Name:
                </span>
                <span class="text-base font-semibold font-roboto">
              ...
              <div class="flex flex-col">
                ...
                <span class="text-base font-semibold break-words font-roboto">
                  {{ profile?.personalEmail || 'N/A' }}
                </span>
              </div>
            </div>

            <!-- Faculty Type + Home Department -->
            <div
              v-if="profile?.memberType"
            ...
            >
              ...
              <div
                v-if="profile.memberType === 'Affiliate'"
                class="flex flex-col"
              >
                <span class="text-sm font-bold text-red-900 font-montserrat">
                  Home Department:
